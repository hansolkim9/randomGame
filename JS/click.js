import{ clickBox, verifyAnswer, $boxWrapper, $modalLayout, userSequence } from "./validate.js";
import { execute, executingValueObject } from "./clickRandomCom.js";


function clickBoxBox() {
  $boxWrapper.addEventListener("click", (e) => {
    if (!e.target.matches(".box-wrapper .box") || !executingValueObject.isExecuting) return;
